package com.shadowbeastgod.eternalexistence.items.customitems;
...
public enum ModArmorMaterials implements ArmorMaterial {
    WAKARANAI("wakaranai", 100, new int[]{10, 16, 18, 13}, 10, SoundEvents.ARMOR_EQUIP_DIAMOND, 2.0F, 0.0F, () -> {
        return Ingredient.of(ModItems.WAKARANAIINGOT.get());
    });
    ...
    public String getName() {
        return EternalExistence.MOD_ID + ":" + this.name;
    }
